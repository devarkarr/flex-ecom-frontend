...
const Navbar = () => {
  return (
    <nav className="px-3 lg:px-20 lg:h-[4.4rem] shadow-xl lg:container lg:mx-auto shadow-gray-100 flex lg:flex-row flex-col lg:items-center justify-between ">
      ...
      <ul className="hidden lg:flex space-x-3 items-center">
        <li>
          <form className=" relative">
            <IoSearch className=" absolute text-2xl top-[0.34rem] left-2.5 text-gray-500 font-semibold" />
            <input type="search" placeholder="Search" className="bg-[#EFF0F6] py-[0.43rem] text-sm px-2 transition-all duration-300 focus:bg-transparent pl-10 rounded-3xl focus:outline-body/40 focus:border-body focus:ring-body focus:outline-1" />
          </form>
        </li>
        <li>
          <button className="nav-button border bg-white ">
            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="23" viewBox="0 0 32 32">
      ...
      {/* mobile */}
      <div className="md:px-5 w-full mb-2.5 md:mb-4 lg:hidden">
        <form className=" relative w-full">
          <IoSearch className=" absolute text-2xl top-[0.34rem] left-2.5 text-gray-500 font-semibold" />
          <input type="search" placeholder="Search" className="bg-[#EFF0F6] w-full py-[0.43rem] text-sm px-2 transition-all duration-300 focus:bg-transparent pl-10 rounded-3xl focus:outline-body/40 focus:border-body focus:ring-body focus:outline-1" />
        </form>
      </div>
    </nav>
  )
